    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "ua.nure.hrynko");
                servletContext.setInitParameter("tapestry.development-modules", "ua.nure.hrynko.services.DevelopmentModule");
